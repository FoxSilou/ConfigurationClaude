...
```
/task-implement-feature-back <feature description or .feature file>
```

## Examples

```
/task-implement-feature-back docs/features/inscription.feature
/task-implement-feature-back créer une partie de jeu avec un nom et une date de début
```
