...
```
/task-implement-feature-auto-back <feature description or .feature file>
```

## Examples

```
/task-implement-feature-auto-back docs/features/confirmation-email.feature
/task-implement-feature-auto-back docs/features/connexion.feature
```
